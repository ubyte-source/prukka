...
// Describe renders a tag for humans and prompts ("Italian (it)"): a model
// must never see a naked two-letter tag, which reads as an English word.
func Describe(tag core.Lang) string {
