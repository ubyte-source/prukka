...
// and separators; failures wrap ErrUnknown with a "did you mean" hint. The
// Auto keyword returns core.LangAuto, a sentinel rather than a tag — callers
// that need a concrete language must reject it explicitly.
