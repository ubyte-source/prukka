...
// ExampleParse shows separator and case normalization, and the "did you mean" hint.
func ExampleParse() {
...
// ExampleParseList shows empties skipped, duplicates collapsed and auto refused.
...
// FuzzParse pins that any tag Parse accepts round-trips back to itself; the
// auto keyword maps to core.LangAuto and is deliberately not re-parseable.
