// Package strictjson decodes single-document JSON contracts with unknown
// fields, trailing data and duplicate object keys all rejected; a lenient
...
// frame is one open container on the walker's stack; only object frames carry
// a key set.
type frame struct {
...
// push opens a container, or closes the innermost one and restores the
