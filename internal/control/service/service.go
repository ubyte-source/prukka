...
type Options struct {
	...
	ExecPath string
	// ConfigPath optionally pins --config for the daemon. It must be
	// absolute: the supervisor starts the daemon from its own working
	// directory, not the installer's.
	ConfigPath string
