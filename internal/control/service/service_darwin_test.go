...
// fakeLaunchctl plants the shared fake tool under the launchctl name,
// failing on the given verb. It also points HOME at a temp dir so plists
// land there and removes the retry pacing.
