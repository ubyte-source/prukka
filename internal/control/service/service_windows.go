...
func install(ctx context.Context, opts *Options) error {
	...
	createErr := runQuiet(exec.CommandContext(ctx, "schtasks", "/Create", "/TN", taskName, "/XML", tmp, "/F"))
...
func endThenRun(ctx context.Context) error {
	...
	endErr := runQuiet(exec.CommandContext(ctx, "schtasks", "/End", "/TN", taskName))
	...
	if runErr := runQuiet(exec.CommandContext(ctx, "schtasks", "/Run", "/TN", taskName)); runErr != nil {
...
func remove(ctx context.Context) error {
	...
	if deleteErr := runQuiet(exec.CommandContext(ctx, "schtasks", "/Delete", "/TN", taskName, "/F")); deleteErr != nil {
...
func installed(ctx context.Context) bool {
	return runQuiet(exec.CommandContext(ctx, "schtasks", "/Query", "/TN", taskName)) == nil
}
