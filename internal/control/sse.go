...
func sseHandler(store *session.Store, log *slog.Logger, dubbed DubbedLanguagesFunc, engine *Engine) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		serveSSE(w, r, store, log, dubbed, engine)
	})
}
...
func serveSSE(
	...
	dubbed DubbedLanguagesFunc, engine *Engine,
) {
