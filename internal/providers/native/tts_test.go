...
func assertCloseUnblocksAudio(t *testing.T, audio *realtime.AudioStream) {
	t.Helper()
...
// TestTTSSpawnPathReportsConfiguredBinary: composition tests can pin which
// executable a synthesizer will run.
