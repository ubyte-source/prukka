...
// newWhisperStub serves one fixed response under whisper.cpp's mandatory Server
// identity; an empty contentType leaves the header unset, as legacy builds do.
