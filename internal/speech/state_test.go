...
// TestReadStateRejectsEscapingPackFileNames: the load must refuse what a
// persisted list may not NAME, or a hand-edited state re-admits it.
...
// TestReadStateRejectsSymlinkedPackFiles: a link where a model belongs is not a
// file any install produced, whatever it resolves to.
