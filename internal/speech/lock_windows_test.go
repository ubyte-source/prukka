...
// The lock lives in the kernel, keyed by the open handle: a second handle on
// the same file must be refused while the first holds the lock and admitted
// the moment the holder closes — which is exactly how a crashed holder is
// recovered from without any staleness clock.
