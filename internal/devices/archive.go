...
// extract unpacks a gzip'd tar into dir, preserving file modes and refusing
// entries that would escape dir. The umask is held open because system daemons
// read the drivers, so a umask-077 sudo shell must not produce 0700 bundles.
