...
// replaceBinary stages binary beside dest and renames it into place; Windows
// moves the running image aside first.
...
// stageBinary lands the new image at the FIXED dest+".new" name, which is a
// contract: deploy/uninstall.sh sweeps crash-time residue by that exact name.
