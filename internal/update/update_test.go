...
// checksumsFixture serves a v9.9.9 release whose checksums.txt content is
// supplied verbatim, for the integrity-failure cases the happy-path fixture
// cannot model.
...
// A checksums.txt that never names the platform archive leaves the download
// unverifiable: Apply must refuse with the missing-entry identity, distinct
// from a mismatch.
