...
//nolint:gosec // G103: Win32 struct-pointer interop; audited, maintainer-approved.
package update
...
// removeReplacedImage applies Windows POSIX deletion semantics: the old name
// disappears now while the running process keeps its mapped image until exit.
