...
// nominalCueDuration times cues whose segment carries no duration.
...
// push appends one cue, evicting the oldest past the roll limit.
...
// CueText joins a cue's lines, escaping the WebVTT cue metacharacters; it is
// the single escaping seam every subtitle sink must use.
