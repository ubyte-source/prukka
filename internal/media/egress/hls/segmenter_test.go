...
func TestPartEscapesCueMetacharacters(t *testing.T) {
	...
	// The HLS rendition and the rolling /subs document project the same
	// translated text; both must escape WebVTT cue metacharacters or a
	// conformant parser mangles the cue. This pins the HLS side to that.
