...
// TestDeviceOutputArgsLinuxVideoWritesRawFramesToTheNode: the webcam node's
// writer contract is plain write(2) of packed yuyv422 frames; the v4l2 muxer
// would probe S_FMT(OUTPUT), which the capture-only node rejects.
