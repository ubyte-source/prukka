...
const (
	...
	btbnRelease = "https://github.com/BtbN/FFmpeg-Builds/releases/download/" +
		"autobuild-2026-07-03-13-21/"
	btbnRevision = "92132ee5d15776864c1e701c4f65675eeb74b729"
	...
	btbnCommit   = "ce3c09c101c83add623774d414a9f9498caf5c25"
...
var builds = map[string]build{
	"linux/amd64": btbnBuild(
		...
		"7aadf7d95d94e9dc71d4283d64be209ef1ba4cab5eb09893c29037223704d0b1",
		kindTarXz,
	),
	"linux/arm64": btbnBuild(
		"linuxarm64",
		"ffmpeg-n8.1.2-21-gce3c09c101-linuxarm64-gpl-8.1.tar.xz",
		"147400f5b6fd2486523f0b010191b5d5c58aaa44c56a296cbd1a3f130cb59329",
		kindTarXz,
	),
	"windows/amd64": btbnBuild(
		"win64",
		"ffmpeg-n8.1.2-21-gce3c09c101-win64-gpl-8.1.zip",
		"68d17ffe72af5254c9ef3912b7ef5d7dae2c01e9006debfdc2279737d8fb0161",
		kindZip,
	),
	"windows/arm64": btbnBuild(
		"winarm64",
		"ffmpeg-n8.1.2-21-gce3c09c101-winarm64-gpl-8.1.zip",
		"c0b38810a44d5a8af96fe43117e4263d288ab3957c3d95d7cc6e6af5dc32d5f2",
		kindZip,
	),
