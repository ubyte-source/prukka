...
// DefaultBufferDuration is the shared-mode playback buffer used when no
// latency-sensitive profile is selected.
...
// WASAPI, rounded up to a whole Windows REFERENCE_TIME tick.
...
// sample decodes one little-endian PCM16 value.
