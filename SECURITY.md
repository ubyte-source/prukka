...
- `prukka setup` (and the dashboard) downloads the pinned FFmpeg runtime and, on
  macOS, also installs and SHA-256-verifies the managed native speech tools and
  model packs. Those assets come from prukka's own GitHub release, the one whose tag
