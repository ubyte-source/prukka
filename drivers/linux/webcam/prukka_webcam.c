...
// device://video//dev/videoN`), and any app that opens it for capture — a browser,
...
#include "../common/platform_module.h"
...
static PRUKKA_REMOVE_TYPE prukka_remove(struct platform_device *pdev)
{
...
PRUKKA_PLATFORM_MODULE("prukka_webcam", prukka_probe, prukka_remove);
