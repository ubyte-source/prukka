...
allocation-free, lookup cost has a hard ceiling, and the audio callback never
touches the ledger or its mutex. If all 256 slots are occupied, registration of
