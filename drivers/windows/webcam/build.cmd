...
cl /nologo /std:c++17 /W4 /O2 /EHsc /LD source.cpp dllmain.cpp ^
  /Fo:build\ /Fe:build\PrukkaWebcam.dll ^
  /link mfplat.lib mfuuid.lib mfsensorgroup.lib ole32.lib advapi32.lib runtimeobject.lib
if errorlevel 1 exit /b 1

echo ==^> compiling PrukkaWebcamCtl.exe
cl /nologo /std:c++17 /W4 /O2 /EHsc camctl.cpp ^
  /Fo:build\ /Fe:build\PrukkaWebcamCtl.exe ^
  /link mfplat.lib mfuuid.lib mfsensorgroup.lib ole32.lib runtimeobject.lib
if errorlevel 1 exit /b 1
