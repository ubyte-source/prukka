...
The Prukka daemon performs this feed automatically after `probe` confirms the
resident controller is live; the manual pipeline is retained for diagnostics.
