...
<section aria-labelledby="events-title" class="min-w-0 rounded-2xl border border-hairline bg-panel p-6 shadow-card">
  <h2 id="events-title" class="mb-4 text-lg font-semibold tracking-tight">{i18n.m.events.title}</h2>
