<script lang="ts">
  ...
  import UnlockControl from "./UnlockControl.svelte";
...
<header
  class="sticky top-0 z-10 -mx-4 flex flex-wrap items-center justify-between
         gap-4 border-b border-hairline bg-surface/80 px-4 py-3
         backdrop-blur-xl sm:-mx-6 sm:px-6"
>
        ...
        <button
          ...
          class={`rounded px-1.5 py-0.5 font-mono text-xs uppercase transition-colors
                  focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand ${
                    i18n.locale === loc
                      ? "bg-panel font-semibold text-brand underline underline-offset-4 shadow-[0_1px_2px_rgb(0_0_0_/_0.15)]"
