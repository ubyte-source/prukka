...
<section
  ...
  aria-busy={loading}
  class="min-w-0 rounded-2xl border border-hairline bg-panel p-6 shadow-card"
>
  <h2 id="doctor-title" class="mb-4 text-lg font-semibold tracking-tight">{i18n.m.doctor.title}</h2>
