...
// have yet" pickers in the sessions table. It distinguishes three states a
// single "unavailable" answer would conflate: a language that is ready, one
// that just needs a quick download (addable), and one that is genuinely
// impossible on this setup.
//
// The wizard deliberately does NOT use this classifier; it asks a narrower
// pack-level question — see addablePack in lib/wizard/state.svelte.ts.
