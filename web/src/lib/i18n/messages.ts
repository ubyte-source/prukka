...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    wizard: {
      ...
      retry: "Retry",
      broadcastDesc: "Add subtitles or a dubbed voice to a stream, event or video for your audience.",
      callDesc: "Translate a live call you're on — hear the other person speak in your language.",
      ...
      source: "Source URL",
      profile: "Profile",
      profileBroadcast: "Broadcast (live stream or video)",
      profileCall: "Call (Zoom, Meet, phone…)",
    ...
    doctor: {
      ...
      tokenRequired:
        "Connect Prukka with the lock in the top bar to run environment checks.",
    ...
    add: {
      ...
      unsupported: "Adding languages isn't available on this version.",
    ...
    unlock: {
      ...
      connected: "Connected",
      explain: "Paste the access code Prukka printed in the terminal to connect.",
      field: "Access code",
      apply: "Unlock",
  ...
  it: {
    ...
    wizard: {
      ...
      retry: "Riprova",
      broadcastDesc: "Aggiungi sottotitoli o una voce doppiata a una diretta, un evento o un video per il tuo pubblico.",
      callDesc: "Traduci una chiamata dal vivo a cui partecipi — senti l'altra persona nella tua lingua.",
      ...
      source: "URL sorgente",
      profile: "Profilo",
      profileBroadcast: "Broadcast (diretta o video)",
      profileCall: "Chiamata (Zoom, Meet, telefono…)",
    ...
    doctor: {
      ...
      tokenRequired:
        "Connetti Prukka con il lucchetto in alto per verificare l'ambiente.",
    ...
    add: {
      ...
      unsupported: "L'aggiunta di lingue non è disponibile in questa versione.",
    ...
    unlock: {
      ...
      connected: "Connesso",
      explain: "Incolla il codice d'accesso che Prukka ha stampato nel terminale per connetterti.",
