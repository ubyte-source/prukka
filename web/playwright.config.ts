...
// webkit comes from the declared @playwright/test (which re-exports
// playwright-core at runtime and in types): importing playwright-core
// directly would lean on npm hoisting a package nobody declared.
