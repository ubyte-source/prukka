...
download_voice() {
  ...
  curl -fsSL --retry 4 --retry-delay 5 -o "$dest/$voice.MODEL_CARD" "$PIPER_VOICES_URL/$path/MODEL_CARD" ||
    { echo "download failed: $PIPER_VOICES_URL/$path/MODEL_CARD" >&2; exit 22; }
