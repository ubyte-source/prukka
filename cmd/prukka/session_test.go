...
func TestPushRetryableWaitsOnlyOnNotReady(t *testing.T) {
	...
	// The CLI replaces the message, so the daemon's status must stay
	// reachable or the wait loop stops recognizing the tagged answer.
